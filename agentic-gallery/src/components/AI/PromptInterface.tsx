...
export const PromptInterface = () => {
    ...
    return (
        <div className="w-full h-fit max-h-fit bg-white/50 rounded-4xl grid-cols-2 gap-5 p-5">
            <textarea className="w-[78%] h-full text-black outline-none bg-black/5 p-2 rounded-lg overflow-hidden wrap-break-word" id="promptInputElement" placeholder="Let me use your mp3 Player to listen together!" required></textarea>
