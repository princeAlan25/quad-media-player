...
const ImageGalleryContent: React.FC = () => {
  const { images, addImages: addImagesToLibrary, removeImage: moveImageToTrash } = useMediaLibrary();
...
export const ImageGallery: React.FC = memo(() => {
